...
<h1 class="text-left">Login</h1>
    ...
    <?php } ?>
            ...
            <p class="login-remember text-left"><label><input name="rememberme" type="checkbox" id="rememberme" value="forever" tabindex="90" /> <?php echo __("Remember Me","odudeshop");?></label></p>
            ...
            <p align='left'>
                <a href='<?php echo site_url('/wp-login.php?action=lostpassword'); ?>' class="delicious" style="font-size: 12pt;"><?php echo __('Forgot Password?','odudeshop'); ?></a> &nbsp;
                <a href='<?php echo site_url('/wp-login.php?action=register'); ?>' class="delicious" style="font-size: 12pt;"><i class="icon icon-user"></i> <?php echo __('Register','odudeshop'); ?></a><br>
            </p>
