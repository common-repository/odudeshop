						...
						<div class='pure-g'>
							 ...
							 <img src='".odude_product_image($item['ID'],'icon')."'>
							  ...
							  <div class='pure-u-1 pure-u-md-3-4' > 
								...
								<div class='pure-u-1-2 pure-u-md-1-2' ><input type='text' name='cart_items[$item[ID]][quantity]' value='$item[quantity]' id='c-$item[ID]' size='5' /></div>
								</div>
