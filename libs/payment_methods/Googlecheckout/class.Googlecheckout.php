...
class Googlecheckout extends CommonVers{
    ...
    function Googlecheckout($TestMode = 0){
        ...
        $this->Currency =  $currency_sign = get_option('_odudes_curr_name','USD');
    ...
    function ConfigOptions(){    
        ...
        $data='<table>
<tr><td>'.__("Enable/Disable:","odudeshop").'</td><td><input type="checkbox" value="1" '.$enabled.' name="_odudes_settings[Googlecheckout][enabled]" style=""> '.__("Enable Googlecheckout","odudeshop").'</td></tr>
<tr><td>'.__("Googlecheckout Mode:","odudeshop").'</td><td><select id="Googlecheckout_mode" name="_odudes_settings[Googlecheckout][Googlecheckout_mode]"><option value="live">Live</option><option value="sandbox" >SandBox</option></select></td></tr>
<tr><td>'.__("Googlecheckout Merchant ID:","odudeshop").'</td><td><input type="text" name="_odudes_settings[Googlecheckout][Googlecheckout_merchant]" value="'.$this->Business.'" /></td></tr>
<tr><td>
Image URL:
</td><td><img src="'.WP_PLUGIN_URL.'/odudeshop/libs/payment_methods/Googlecheckout/logo.jpg"><br>
'.WP_PLUGIN_URL.'/odudeshop/libs/payment_methods/Googlecheckout/logo.jpg
</td></tr>
</table>
<script>
...
';
    ...
    function ShowPaymentForm($AutoSubmit = 0){
        ...
        $Googlecheckout = plugins_url().'/odudeshop/images/Googlecheckout.png';
        $Form = " 
        ...
        if($AutoSubmit==1)
        $Form .= "<center><b>".__("Processing....","odudeshop")."</b></center><script language=javascript>setTimeout('document._wpdm_bnf_{$this->InvoiceNo}.submit()',2000);</script>";
