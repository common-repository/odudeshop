...
class Paypal extends CommonVers{
    ...
    function Paypal($TestMode = 0)
	{
        ...
        $this->NotifyUrl = home_url('?action=odudes-payment-notification&class=Paypal');
	...
	{    
        ...
        $data='<table>
<tr><td>'.__("Enable/Disable:","odudeshop").'</td><td><input type="checkbox" value="1" '.$enabled.' name="_odudes_settings[Paypal][enabled]" style=""> '.__("Enable Paypal","odudeshop").'</td></tr>
<tr><td>'.__("Paypal Mode:","odudeshop").'</td><td><select id="Paypal_mode" name="_odudes_settings[Paypal][Paypal_mode]"><option value="live">Live</option><option value="sandbox" >SandBox</option></select></td></tr>
<tr><td>'.__("Paypal Email:","odudeshop").'</td><td><input type="text" name="_odudes_settings[Paypal][Paypal_email]" value="'.$this->Business.'" /></td></tr>
<tr><td>'.__("Cancel Url:","odudeshop").'</td><td><input type="text" name="_odudes_settings[Paypal][cancel_url]" value="'.$this->CancelUrl.'" /></td></tr>
<tr><td>'.__("Return Url:","odudeshop").'</td><td><input type="text" name="_odudes_settings[Paypal][return_url]" value="'.$this->ReturnUrl.'" /></td></tr>
<tr><td>
Image URL:
</td><td><img src="'.WP_PLUGIN_URL.'/odudeshop/libs/payment_methods/Paypal/logo.jpg"><br>
'.WP_PLUGIN_URL.'/odudeshop/libs/payment_methods/Paypal/logo.jpg
</td></tr>
</table>
<script>
...
';
    ...
    function ShowPaymentForm($AutoSubmit = 0)
	{
        ...
        $Paypal = plugins_url().'/odudeshop/images/cart.png';
        $Form = " 
