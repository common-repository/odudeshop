...
class Cashondelivery extends CommonVers{
	...
	{    
		...
		if(isset($settings['Cashondelivery']['enabled']))
        $this->Enabled = $settings['Cashondelivery']['enabled'];
		if(isset($settings['Cashondelivery']['Message']))
        $this->Message = stripslashes($settings['Cashondelivery']['Message']);
        ...
        $data='<table>
<tr><td>'.__("Enable/Disable:","odudeshop").'</td><td><input type="checkbox" value="1" '.$enabled.' name="_odudes_settings[Cashondelivery][enabled]" style=""> '.__("Enable Cashondelivery","odudeshop").'</td></tr>
<tr><td>'.__("Remark:","odudeshop").'</td><td><textarea name="_odudes_settings[Cashondelivery][Message]">'.$this->Message.'</textarea></td></tr>
<tr><td>
Image URL:
</td><td><img src="'.WP_PLUGIN_URL.'/odudeshop/libs/payment_methods/Cashondelivery/logo.jpg"><br>
'.WP_PLUGIN_URL.'/odudeshop/libs/payment_methods/Cashondelivery/logo.jpg
</td></tr>
</table>';
        return $data;
    }
    ...
    function ShowPaymentForm($AutoSubmit = 0){
        ...
        $Cashondelivery = plugins_url().'/odudeshop/images/Cashondelivery.png';
        $Form = " 
