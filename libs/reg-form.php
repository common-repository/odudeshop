...
<b><?php echo __("Registration Failed!","odudeshop");?></b><br/>
...
<h1>Register</h1>
    <p>
        <label><?php echo __("Username","odudeshop");?><br>
    ...
    <p>
        <label><?php echo __("E-mail","odudeshop");?><br>
    ...
    <p id="reg_passmail"><?php echo __("A password will be e-mailed to you.","odudeshop");?></p>
    <br class="clear">
    <input type="hidden" value="" name="redirect_to">
    <p class=""><input type="submit" tabindex="100" value="Register" class="reg" id="wp-submit" name="wp-submit"></p>
    <p>     <br>
    
            <a href='<?php the_permalink(); ?>/login/' class="delicious" style="font-size: 12pt;"><?php echo __("Already have account? Login","odudeshop");?></a><br>            
