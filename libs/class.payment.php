...
class Payment{
    ...
    function ListMethods() {
         global $wpdb;
         $methods = $wpdb->get_results("select * from {$wpdb->prefix}os_payment_methods where enabled='1'",ARRAY_A);                  
         return $methods;
    } 
    
    function CountMethods(){
         global $wpdb;
         return $wpdb->get_var("select count(*) from {$wpdb->prefix}os_payment_methods where enabled='1'");                  
    }
