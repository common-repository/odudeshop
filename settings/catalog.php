...
query_posts('post_type=odudeshop&posts_per_page=15&paged='.$wp_query->query_vars['paged']);
...
<div class="pin">
    ...
    <div class="pull-left">
    <?php echo get_option('_odudes_curr_sign','$').odudes_product_price(get_the_ID()); ?>
    </div>
    <div class="pull-right">sssssssssssssssss
        <?php echo odudes_addtocart_link(get_the_ID()); ?>
    </div>
